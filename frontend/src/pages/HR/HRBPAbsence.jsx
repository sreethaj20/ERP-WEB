...
export default function HRBPAbsence() {
    ...
    <div className="dashboard fade-in">
      ...
      <div className="dashboard-card" style={{ padding: 18 }}>
        ...
        <p style={{ margin: 0, color: "#475569" }}>
          This module is under development. Absence rates and cost insights will be available here soon.
        </p>
      </div>
    </div>
  );
